...
\begin{frame}
  \frametitle{Tuples}
  \includegraphics[height=\sizeforimages\textheight]{tuples.png}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.8\textwidth}
      \includegraphics[height=\sizeforimages\textheight]{tuples-dead.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.8\textwidth}
      \includegraphics[height=\sizeforimages\textheight]{tuples-removed.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.8\textwidth}
      \includegraphics[height=\sizeforimages\textheight]{tuples-moving.png}
    \end{column}
  \end{columns}
\end{frame}
