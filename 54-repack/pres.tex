...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.20\textwidth}
      \includegraphics[height=0.7\textheight]{images/tuples_dead.png} \\
      \relscale{0.5}
      some dead tuples
    \end{column}
    \begin{column}{0.20\textwidth}
      \includegraphics[height=0.7\textheight]{images/tuples_removed.png} \\
      \relscale{0.5}
      dead tuples are removed
    \end{column}
    \begin{column}{0.20\textwidth}
      \includegraphics[height=0.7\textheight]{images/tuples_moving.png} \\
      \relscale{0.5}
      tuples moved to final locations
    \end{column}
    \begin{column}{0.20\textwidth}
      \includegraphics[height=0.7\textheight]{images/tuples_compacted.png} \\
      \relscale{0.5}
      tuples in final locations
    \end{column}
    \begin{column}{0.20\textwidth}
      \includegraphics[height=0.7\textheight]{images/tuples_truncated.png} \\
      \relscale{0.5}
...
%     \end{column}
%     \begin{column}{0.33\textwidth}
%       \includegraphics[height=\sizeforimages\textheight]{images/tuples_truncated.png}
%     \end{column}
%   \end{columns}
% \end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Modify \texttt{ALTER TABLE} to rewrite tables using concurrent repack
  \end{itemize}
\end{frame}
