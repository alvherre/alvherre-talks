...
\begin{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.6\textwidth}
      ...
      \begin{center}
	\vspace{0.15cm}
	Antonín Houska, \href{https://cybertec.at/}{\color{black} CYBERTEC} \\
	\href{mailto:ah@cybertec.at}{\color{black}\texttt{ah@cybertec.at}} \\
	\href{https://cybertec.at/}{https://cybertec.at/} \\
	\vspace{0.3cm}
	Álvaro Herrera, {\href{https://enterprisedb.com/}{\color{bluecoal} EDB}} \\
	\href{mailto:alvherre@kurilemu.de}{\color{black}\texttt{alvherre@kurilemu.de}}
	\href{https://enterprisedb.com/}{https://enterprisedb.com/} \\
      \end{center}
    \end{column}
